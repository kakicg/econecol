...
function generate_the_site_logo_tag($is_header = true){
  ...
  $logo_before_tag = '<'.$tag.' class="logo'.$class.'"><a href="https://syneco.co.jp/" class="site-name site-name-text-link" itemprop="url"><span class="site-name-text" itemprop="name about">';
